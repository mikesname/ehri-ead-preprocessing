 ...
 */
public class AddPaths extends TransformerTask {

    public AddPaths(String eadFilePath) {
        super(eadFilePath);
    }

    public static void main(String[] args) throws XMLStreamException, FactoryConfigurationError, IOException {
        String eadFile = args[0];
        new AddPaths(eadFile).run(eadFile.replace(".xml", "_wpath.xml"));
    }
    ...
    void transform(XMLEventReader reader, XMLEventWriter writer) throws XMLStreamException, IOException {
        ...
        boolean hasRevDesc = TagFinder.hasTag(eadFilePath, "revisiondesc");
        boolean hasHead = TagFinder.hasTag(eadFilePath, "head");
        boolean hasProfileDesc = TagFinder.hasTag(eadFilePath, "profiledesc");
    ...
    private void writeProvenance(XMLEventWriter writer, XMLEvent end) throws XMLStreamException {
